            ...
            <div className="card">
                ...
                <div className="card-body">
                    ...
                    <div className="p-2 w-50 bd-highlight">
                        ...
                        <button onClick={() => { RestoreFromBackup() }} className="btn btn-danger">Restaurare bază de date</button>
                    </div>
                    <div className="col-lg-12">
                        <button onClick={() => { CreateBackup() }} className="btn btn-primary">Creaţi backup</button>
                    </div>
                </div>
            </div>
        </div>
